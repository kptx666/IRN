...
parser.add_argument("--cuda", action="store_true", default=True,
                    help="use cuda")
parser.add_argument("--resume", default="checkpoint_x4", type=str,
                    help="path to checkpoint")
parser.add_argument("--start-epoch", default=545, type=int,
                    help="manual epoch number")
parser.add_argument("--threads", type=int, default=0,
                    help="number of threads for dataset_utils loading")
parser.add_argument("--root", type=str, default="D://dataset//npy_data//",
...
parser.add_argument("--pretrained", default="./checkpoint_x4//best_epoch_544.pth", type=str,
                    help="path to pretrained MSR")
...
model = ConvNeXt(upscale_factor=args.scale)
...
#         print("===> loading MSR '{}'".format(args.pretrained))
...
#
#     else:
#         print("===> no MSR found at '{}'".format(args.pretrained))
...
if os.path.exists(args.pretrained):
    ...
    print('加载 epoch {} 成功！'.format(args.start_epoch - 1))
# if os.path.exists(args.pretrained):
#     model_dict = model.state_dict()
#     checkpoint = torch.load(args.pretrained)
